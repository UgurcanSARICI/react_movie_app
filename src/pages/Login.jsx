    ...
    <div className="flex justify-center">
      ...
      <div className="overflow-hidden flex-1 h-screen justify-center items-center dark:bg-[#23242a]">
        ...
        >
          ...
          >
            <h2 className="text-[#4673d4] text-2xl font-[500] text-center tracking-[0.1em]">
              Sign in
            </h2>
            <div className="relative w-[300px] mt-[35px] inputbox">
              ...
              <i className="absolute left-0 bottom-0 w-[100%] h-[2px] bg-[#4673d4] rounded-[4px]"></i>
            </div>
            <div className="relative w-[300px] mt-[35px] inputbox">
              <input
                type="password"
            ...
            <input
              className="border-none outline-none bg-[#4673d4] custom-input w-[100px] mt-[10px] rounded-[4px] font-[600] cursor-pointer"
              type="submit"
              value="Login"
            />
            <button
              className="flex justify-between border-none outline-none bg-[#4673d4] custom-input w-[300px] mt-[15px] rounded-[4px] font-[600] cursor-pointer"
              type="button"
